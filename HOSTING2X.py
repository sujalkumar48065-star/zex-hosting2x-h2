...
def lilm_font(text):
    ...
    for i, l in enumerate(links):
        text = text.replace(l, f"__L{i}__")

    for i, u in enumerate(users):
        text = text.replace(u, f"__U{i}__")

    for i, c in enumerate(cmds):
        text = text.replace(c, f"__C{i}__")
    ...
    for i, l in enumerate(links):
        text = text.replace(f"__L{i}__", l)

    for i, u in enumerate(users):
        text = text.replace(f"__U{i}__", u)
...
COMMAND_BUTTONS_LAYOUT_USER_SPEC = [
    ["📢 𝐔ᴩᴅᴀᴛᴇꜱ 𝐂ʜᴀɴɴᴇʟ"],
    ["📤 𝐃ᴇᴩʟᴏʏ 𝐅ɪʟᴇ", "📂 𝐌ʏ 𝐅ɪʟᴇ"],
    ["⚡𝐁ᴏᴛ 𝐒ᴩᴇᴇᴅ", "📊 𝐒ᴛᴀᴛɪꜱᴛɪᴄꜱ"],
    ["📞 𝐁ᴏᴛ 𝐎ᴡɴᴇʀ"],
    ["📦 𝐈ɴꜱᴛᴀʟʟ 𝐌ᴀɴᴜᴀʟʟʏl", "🆘 𝐆ᴜɪᴅᴇ"]
]
...
ADMIN_COMMAND_BUTTONS_LAYOUT_USER_SPEC = [
    ...
    ["👑 Admin Panel", "📞 𝐁ᴏᴛ 𝐎ᴡɴᴇʀ"],
    ["📢 Channel Add", "🛠️ 𝐈ɴꜱᴛᴀʟʟ 𝐌ᴀɴᴜᴀʟʟʏl"],
...
def create_main_menu_inline(user_id):
    markup = types.InlineKeyboardMarkup(row_width=2)
    buttons = [
        types.InlineKeyboardButton('📢 𝐔ᴩᴅᴀᴛᴇꜱ 𝐂ʜᴀɴɴᴇʟ', url=f'https://t.me/{UPDATE_CHANNEL.replace("@", "")}'),
        types.InlineKeyboardButton('📤 𝐃ᴇᴩʟᴏʏ 𝐅ɪʟᴇ', callback_data='upload'),
        types.InlineKeyboardButton('📂 𝐌ʏ 𝐅ɪʟᴇ', callback_data='check_files'),
        types.InlineKeyboardButton('⚡𝐁ᴏᴛ 𝐒ᴩᴇᴇᴅ', callback_data='speed'),
        types.InlineKeyboardButton('📦 𝐈ɴꜱᴛᴀʟʟ 𝐌ᴀɴᴜᴀʟʟʏl', callback_data='manual_install'),
        types.InlineKeyboardButton('📞 𝐁ᴏᴛ 𝐎ᴡɴᴇʀ', url=f'https://t.me/{YOUR_USERNAME.replace("@", "")}')
    ]

    if user_id in admin_ids:
        admin_buttons = [
            types.InlineKeyboardButton('💳 Subscriptions', callback_data='subscription'), #0
            types.InlineKeyboardButton('📊 𝐒ᴛᴀᴛɪꜱᴛɪᴄꜱ', callback_data='stats'), #1
        ...
        markup.add(types.InlineKeyboardButton('📊 𝐒ᴛᴀᴛɪꜱᴛɪᴄꜱ', callback_data='stats')) # Allow non-admins to see stats too
...
def create_control_buttons(script_owner_id, file_name, is_running=True):
    ...
    if is_running:
        markup.row(
            types.InlineKeyboardButton("🔴 𝐒ᴛᴏᴩ ", callback_data=f'stop_{script_owner_id}_{file_name}'),
...
def _logic_updates_channel(message):
    markup = types.InlineKeyboardMarkup()
    markup.add(types.InlineKeyboardButton('📢 𝐔ᴩᴅᴀᴛᴇꜱ 𝐂ʜᴀɴɴᴇʟ', url=f'https://t.me/{UPDATE_CHANNEL.replace("@", "")}'))
...
def _logic_check_files(message):
    ...
    for file_name, file_type in sorted(user_files_list):
        ...
        status_icon = "🟢 𝐑ᴜɴɴɪɴɢ" if is_running else "🔴 𝐒ᴛᴏᴩᴩᴇᴅ"
...
• Manual install via "📦 𝐈ɴꜱᴛᴀʟʟ 𝐌ᴀɴᴜᴀʟʟʏl" button
...
BUTTON_TEXT_TO_LOGIC = {
    "📢 𝐔ᴩᴅᴀᴛᴇꜱ 𝐂ʜᴀɴɴᴇʟ": _logic_updates_channel,
    "📤 𝐃ᴇᴩʟᴏʏ 𝐅ɪʟᴇ": _logic_upload_file,
    "📂 𝐌ʏ 𝐅ɪʟᴇ": _logic_check_files,
        "⚡𝐁ᴏᴛ 𝐒ᴩᴇᴇᴅ": _logic_bot_speed,
    "📞 𝐁ᴏᴛ 𝐎ᴡɴᴇʀ": _logic_contact_owner,
    "📊 𝐒ᴛᴀᴛɪꜱᴛɪᴄꜱ": _logic_statistics, 
    ...
    "🛠️ 𝐈ɴꜱᴛᴀʟʟ 𝐌ᴀɴᴜᴀʟʟʏl": _logic_manual_install,
    "⚙️ Settings": _logic_admin_settings,
    "📦 𝐈ɴꜱᴛᴀʟʟ 𝐌ᴀɴᴜᴀʟʟʏl": _logic_manual_install,
    "🆘 𝐆ᴜɪᴅᴇ": _logic_help
}
